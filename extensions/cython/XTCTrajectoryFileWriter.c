/* Generated by Cython 0.15.1 on Thu Sep 18 18:39:15 2014 */
 ...
 * 
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s__Close); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         self.currentFrame   = 0
 */
  __pyx_t_4 = PyObject_GetAttr(__pyx_v_owner, __pyx_n_s__atoms); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
 ...
 *         natoms        = self.numberOfAtoms
 */
  __pyx_t_1 = PyObject_GetAttr(((struct __pyx_obj_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter *)__pyx_v_self)->owner, __pyx_n_s__coordinates3); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(((__pyx_t_1) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5pCore_12Coordinates3_Coordinates3))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_2 = __Pyx_PyInt_from_py_Integer(((struct __pyx_obj_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter *)__pyx_v_self)->precision); if (unlikely((__pyx_t_2 == (Integer)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_2 = __Pyx_PyInt_from_py_Integer(((struct __pyx_obj_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter *)__pyx_v_self)->numberOfAtoms); if (unlikely((__pyx_t_2 == (Integer)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 112; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyInt_from_py_Integer(((struct __pyx_obj_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter *)__pyx_v_self)->currentFrame); if (unlikely((__pyx_t_2 == (Integer)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    __pyx_t_1 = PyNumber_Add(((struct __pyx_obj_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter *)__pyx_v_self)->currentFrame, __pyx_int_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_GIVEREF(__pyx_t_1);
    __Pyx_GOTREF(((struct __pyx_obj_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter *)__pyx_v_self)->currentFrame);
    __Pyx_DECREF(((struct __pyx_obj_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter *)__pyx_v_self)->currentFrame);
...
static int __pyx_tp_traverse_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter(PyObject *o, visitproc v, void *a) {
  ...
  if (p->numberOfFrames) {
    e = (*v)(p->numberOfFrames, a); if (e) return e;
  }
  if (p->numberOfAtoms) {
    e = (*v)(p->numberOfAtoms, a); if (e) return e;
  }
  if (p->currentFrame) {
...
static int __pyx_tp_clear_23XTCTrajectoryFileWriter_XTCTrajectoryFileWriter(PyObject *o) {
  ...
  p->path = Py_None; Py_INCREF(Py_None);
  Py_XDECREF(tmp);
  tmp = ((PyObject*)p->numberOfFrames);
  p->numberOfFrames = Py_None; Py_INCREF(Py_None);
  Py_XDECREF(tmp);
  tmp = ((PyObject*)p->numberOfAtoms);
  p->numberOfAtoms = Py_None; Py_INCREF(Py_None);
  Py_XDECREF(tmp);
